...
class LLMClient:
    ...
    def generate_test_file(
        ...
        """
        prompt = self._build_test_file_prompt(functions, source_file, imports, framework)
    ...
    def _build_test_file_prompt(
        ...
        return f"""You are an expert Python test engineer. Generate a COMPLETE, PRODUCTION-READY test file using {framework.value}.
